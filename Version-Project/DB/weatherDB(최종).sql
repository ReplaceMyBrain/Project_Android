...
CREATE TABLE `ad` (
  ...
  `ad_indate` datetime DEFAULT NULL,
  `ad_outdate` datetime DEFAULT NULL,
  `ad_checkdate` datetime DEFAULT NULL,
  PRIMARY KEY (`id_ad`),
...
CREATE TABLE `payment` (
  ...
  `payment_indate` datetime DEFAULT NULL,
  `payment_outdate` datetime DEFAULT NULL,
  PRIMARY KEY (`id_payment`),
  KEY `fk_payment_ad1_idx` (`ad_id_ad`),
  CONSTRAINT `fk_payment_ad1` FOREIGN KEY (`ad_id_ad`) REFERENCES `ad` (`id_ad`)
...
-- Dump completed on 2021-06-27 13:54:26
