...
public class ClothesChoiceActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        ChoiceBean.clear();
        for (int i = 1; i <= 15; i++) {
            ChoiceBean choiceBean = new ChoiceBean(i + "", false);
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_reset:
                ...
                try {
                    ...
                    switch (choice.get(0)) {
                        case "-5º ▼":
                            query = "UPDATE clothes SET item1 ='10',item2 ='11',item3 ='14',item4 ='15',item5 ='null' WHERE Temperature = '"+choice.get(0)+"';";
                            break;
                        case "-5º ~ 0º":
                            query = "UPDATE clothes SET item1 ='9',item2 ='10',item3 ='11',item4 ='14',item5 ='15' WHERE Temperature ='"+choice.get(0)+"';";
                            break;
                        case "0º ~ 5º":
                            query = "UPDATE clothes SET item1 ='7',item2 ='9',item3 ='10',item4 ='12',item5 ='14' WHERE Temperature ='"+choice.get(0)+"';";
                            break;
                        case "5º ~ 10º":
                            query = "UPDATE clothes SET item1 ='5',item2 ='6',item3 ='8',item4 ='7',item5 ='12' WHERE Temperature ='"+choice.get(0)+"';";
                            break;
                        case "10º ~ 15º":
                            query = "UPDATE clothes SET item1 ='5',item2 ='6',item3 ='8',item4 ='12',item5 ='null' WHERE Temperature ='"+choice.get(0)+"';";
                            break;
                        case "15º ~ 20º":
                            query = "UPDATE clothes SET item1 ='3',item2 ='4',item3 ='12',item4 ='null',item5 ='null' WHERE Temperature ='"+choice.get(0)+"';";
                            break;
                        case "20º ~ 25º":
                            query = "UPDATE clothes SET item1 ='2',item2 ='3',item3 ='4',item4 ='12',item5 ='13' WHERE Temperature ='"+choice.get(0)+"';";
                            break;
                        case "25º ~ 30º":
                            query = "UPDATE clothes SET item1 ='2',item2 ='12',item3 ='13',item4 ='null',item5 ='null' WHERE Temperature ='"+choice.get(0)+"';";
                            break;
                        case "30º ▲":
                            query = "UPDATE clothes SET item1 ='1',item2 ='2',item3 ='13',item4 ='null',item5 ='null' WHERE Temperature ='"+choice.get(0)+"';";
                            break;
                    }
                    DB.execSQL(query);
                    clothesSQLite.close();
